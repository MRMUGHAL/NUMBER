# coding: utf-8
# Decompiled By Sohaib ALi MuGhaL
# Github : https://github.com/MRMUGHAL
# uncompyle6 version 
# Original written By Sohaib MuGhal


import os, sys, time, datetime, random, hashlib, re, threading, json, urllib, cookielib, getpass
__author__ = 'Sohaib'
__copyright = 'All rights reserved . Copyright  Sohaib MuGhaL'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[92m  [SOHAIB_CP]  ' + k + c + user + '  |  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;92m  [Sohaib_CP] ' + k + c + user + '  |  ' + pass2
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m  [Sohaib_CP]  ' + k + c + user + '  |  ' + pass3
                        okb = open('save/CP.txt', 'a')
